...
csv_file_path = r'C:\Users\s_muh\Downloads\customers.csv'  # Replace with the path to your CSV file
df = pd.read_csv(csv_file_path)

# Load the DataFrame into PostgreSQL
table_name = 'Abbas_table'  # Replace with the name of the table you want to create or append to
